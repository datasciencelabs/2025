...
| Nov 17 | Association tests and causation  | [Association is not causation](slides/other-topics/32-association-not-causation.qmd) | [Association tests](https://rafalab.dfci.harvard.edu/dsbook-part-2/linear-models/association-tests.html), [Association is not causation](https://rafalab.dfci.harvard.edu/dsbook-part-2/linear-models/association-not-causation.html) | Robert |
...
|  Dec 08, Dec 10, Dec 15 | Machine Learning | [Smoothing](slides/ml/40-smoothing.qmd), [kNN](slides/ml/41-knn.qmd), [Resampling methods](slides/ml/42-resampling-methods.qmd), [caret package](slides/ml/43-caret.qmd), [Algorithms](slides/ml/44-algorithms.qmd), [ML in practice](slides/ml/45-ml-in-practice.qmd)| [smoothing](https://rafalab.dfci.harvard.edu/dsbook-part-2/ml/smoothing.html), [Resampling methods](https://rafalab.dfci.harvard.edu/dsbook-part-2/ml/resampling-methods.html), [ML algorithms](https://rafalab.dfci.harvard.edu/dsbook-part-2/ml/algorithms.html), [ML in practice](https://rafalab.dfci.harvard.edu/dsbook-part-2/ml/ml-in-practice.html) | Anthony |
